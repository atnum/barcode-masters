DROP TABLE BM_GENERIC_LABELS ;

DROP TABLE BM_GENERIC_LABELS_TEMP ;

DROP TABLE BM_USER ;

DROP TABLE BM_ROLE;

DROP TABLE BM_PRODUCT
...
INSERT INTO bm_user (user_id, first_name, last_name, email, user_name, password, enabled) VALUES
...
INSERT INTO bm_role (role_id, user_id, role) VALUES
(1, 1, 'ROLE_ADMIN');
...
AFTER
  INSERT
    ON BM_GENERIC_LABELS FOR EACH ROW 
    DECLARE 
  BEGIN
      
        INSERT
        INTO
          BM_GENERIC_LABELS_TEMP
          (
            PRINT_LABEL_GROUP_NBR,
            FACILITY_ID,
            CONTAINER_ID 
